...
def execute():
    ...
    fields = {"Patient Appointment": [{"fieldname": "apply_fasttrack_charge",
                                       "fieldtype": "Check",
              ...
              "Appointment Type": [{"fieldname": "source_sec",
    ...
    for row in fields:
        for key, value in row.items():
            for fieldname in value:
                custom_field = frappe.get_cached_value("Custom Field", {"fieldname": fieldname, "dt": key}, "name")
                if custom_field:
