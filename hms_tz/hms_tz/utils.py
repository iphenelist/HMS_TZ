...
def render_doc_as_html(doctype, docname, exclude_fields=None, use_setttings=False):
	...
	if use_setttings:
		...
		selected_fields = [
			d.selected_fields for d in settings.standard_doctypes if d.document_type == doctype
		]
		if not selected_fields:
			selected_fields = [
				d.selected_fields for d in settings.custom_doctypes if d.document_type == doctype
			]
