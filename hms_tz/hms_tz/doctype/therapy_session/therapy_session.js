      ...
      frm.add_custom_button(
        ...
        function () {
          frappe.model.open_mapped_doc({
            method:
              "hms_tz.hms_tz.doctype.patient_assessment.patient_assessment.create_patient_assessment",
            frm: frm,
          });
        },
        "Create"
          ...
          if (r && !r.therapy_plan_template) {
            frm.add_custom_button(
              ...
              function () {
                frappe.model.open_mapped_doc({
                  method:
                    "hms_tz.hms_tz.doctype.therapy_session.therapy_session.invoice_therapy_session",
                  frm: frm,
                });
              },
              "Create"
