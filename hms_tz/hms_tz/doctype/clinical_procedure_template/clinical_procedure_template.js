...
frappe.ui.form.on("Clinical Procedure Template", {
  ...
  refresh: function (frm) {
    ...
    frm.fields_dict["company_options"].grid.get_field(
      "service_unit"
  ...
  let d = new frappe.ui.Dialog({
    ...
    primary_action: function () {
      ...
      if (values) {
        frappe.call({
          method:
            "healthcare.healthcare.doctype.clinical_procedure_template.clinical_procedure_template.change_item_code_from_template",
...
frappe.ui.form.on("Clinical Procedure Item", {
  ...
  uom: function (doc, cdt, cdn) {
    ...
    if (d.uom && d.item_code) {
      return frappe.call({
        method:
          "erpnext.stock.doctype.stock_entry.stock_entry.get_uom_details",
        args: {
  ...
  item_code: function (frm, cdt, cdn) {
    ...
    if (d.item_code) {
      ...
      return frappe.call({
        method:
          "healthcare.healthcare.doctype.clinical_procedure_template.clinical_procedure_template.get_item_details",
        args: { args: args },
        callback: function (r) {
          if (r.message) {
            let d = locals[cdt][cdn];
...
frappe.tour["Clinical Procedure Template"] = [
  ...
  },
  {
    ...
    description:
      ...
      "<a href='https://docs.erpnext.com/docs/user/manual/en/healthcare/clinical_procedure_template#22-manage-procedure-consumables' target='_blank'>here</a>" +
      __(" to know more"),
  },
  {
