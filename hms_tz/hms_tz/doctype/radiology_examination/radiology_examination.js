      ...
      frappe.call({
        ...
        callback: function (data) {
          if (data.message && data.message.name) {
            ...
            patient_details_html +=
              "Appointment Type : " + appointment.appointment_type + "<br/>";
            patient_details_html +=
              "Practitioner : " + appointment.practitioner + "<br/>";
            ...
            frm.set_value(
              ...
              data.message.radiology_examination_template
            );
          ...
          if (r.message) {
            ...
            if (r.message.referring_practitioner) {
              frm.set_value(
                ...
                r.message.referring_practitioner
              );
...
var show_radiology_procedure = function (frm, result) {
  ...
  $.each(result, function (x, y) {
    ...
    row.find("a").click(function () {
      frm.set_value(
        "radiology_examination_template",
        $(this).attr("data-radiology-template")
      );
      frm.set_value(
