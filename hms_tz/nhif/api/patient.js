frappe.ui.form.on('Patient', {
    ...
    insurance_provider: function (frm) {
        if (frm.doc.card_no && frm.doc.insurance_provider && frm.doc.insurance_provider == 'NHIF') {
            get_patient_info(frm, 'card_no');
        } else  if (frm.doc.national_id && frm.doc.insurance_provider && frm.doc.insurance_provider == 'NHIF') {
            get_patient_info(frm, 'national_id');
        }
    },
    mobile: function (frm) {
    ...
    $(`<div class="modal-body ui-front">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><img src="${frm.doc.image}" alt="Current Image" style="width: 100px; height: 100px;" /></td>
                <td><img src="${patient_data.MemberPicture}" alt="New Image" style="width: 100px; height: 100px;" /></td>
            </tr>
        </tbody>
        </table>
    </div>`).appendTo(d.body);
